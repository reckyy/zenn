...
よく開くアプリをここに登録しておけば、いつでもCmd + 1~8 で開けます！！
...
Cmd + F で開いているページ内容について質問できます。追加当初は、単純に文章を検索したい時にも質問になってしまって煩わしかったです。今は、検索結果が見つからなかった時のみ質問になるように改善されました！アプデが早くて素晴らしいです。。
- 5 second preview
