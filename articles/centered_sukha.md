...
:::message alert
ただ注意していただきたいのは、タスクに時間が設定されているのは**有料会員**のみです。。😭
...
:::message
**10月4日追記**
こちらに誤りがありました。Sukhaでも今の経過時間は見れました。
残り時間の上のTime to next BreakをクリックするとTime Workedに変えることができます。
![](/images/sukha_break.png)
![](/images/sukha_worked.png)
:::
