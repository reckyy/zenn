...
---
## はじめに
この記事では、生産性が高まるポモドーロアプリ[Sukha](https://www.thesukha.co/full)について、以前まで使用していたツールと違うところなども織り交ぜて、紹介します。
...
:::message alert
ただ注意していただきたいのは、タスク2時間が設定されているのは**有料会員**のみです。。😭
無料版だとタスクのみが登録でき、タスクごとに時間はカウントされません。
有料会員は月$10です。得られる恩恵が大きいので僕は有料会員です。
:::
...
## SushiWorkとの違い
最後に、記事前半でも出てきた僕がSukhaの前にずっっと使っていた[SushiWork](https://sushiwork.com/) とSukhaで異なる点、その後に何故Sukhaへ移行したのか記します。
